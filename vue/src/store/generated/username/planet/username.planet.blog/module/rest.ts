...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/username/planet/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/username/planet/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/username/planet/blog/post
   */
  queryPostAll = (
    query?: {
    ...
    this.request<BlogQueryAllPostResponse, RpcStatus>({
      path: `/username/planet/blog/post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/username/planet/blog/sent_post
   */
  querySentPostAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryAllSentPostResponse, RpcStatus>({
      path: `/username/planet/blog/sent_post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/username/planet/blog/timedout_post
   */
  queryTimedoutPostAll = (
    ...
    this.request<BlogQueryAllTimedoutPostResponse, RpcStatus>({
      path: `/username/planet/blog/timedout_post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
