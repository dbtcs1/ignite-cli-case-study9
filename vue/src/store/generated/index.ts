...
import UsernamePlanetUsernamePlanetBlog from './username/planet/username.planet.blog'
...
export default { 
  ...
  UsernamePlanetUsernamePlanetBlog: load(UsernamePlanetUsernamePlanetBlog, 'username.planet.blog'),
